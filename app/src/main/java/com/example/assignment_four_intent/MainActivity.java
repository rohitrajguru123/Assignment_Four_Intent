package com.example.assignment_four_intent;
...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView imageView;
    Button btndog, btncat, btntiger, btnelephant;
    ...
    private void initializeListeners() {
        btndog.setOnClickListener(v -> sendImagesToDisplayActivity(new int[]{R.drawable.dog1, R.drawable.dog2, R.drawable.dog3, R.drawable.dog4}));
        ...
        btntiger.setOnClickListener(v -> sendImagesToDisplayActivity(new int[]{R.drawable.tiger1, R.drawable.tiger2, R.drawable.tiger3, R.drawable.tiger4}));
        btnelephant.setOnClickListener(v -> sendImagesToDisplayActivity(new int[]{R.drawable.elephant1, R.drawable.elephant2, R.drawable.elephant3, R.drawable.elephant4}));
    }
